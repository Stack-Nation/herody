...
class MemberManageController extends Controller
{
    public function ShowAllMember()
    {
        ...
        return view('manager.member.all_member',compact('users','serials'));
    }
    ...
    public function ShowMemberDetails($id)
    {
        ...
        return view('manager.member.view_member',compact('userById'));
    }
    ...
    public function WithdrawReport($id)
    {
        ...
        return view('manager.member.withdraw_report', compact('withdrawLogs'));
    }
    ...
    public function CampaignReport($id)
    {
        ...
        return view('manager.member.campaign_report',compact('acampaigns'));
    }
    ...
    public function projectReport($id)
    {
        ...
        return view('manager.member.project_report',compact('aprojects'));
    }
    ...
    public function gigReport($id)
    {
        ...
        return view('manager.member.gig_report',compact('agigs'));
    }

    public function pending(){
        $users = User::where('app_status',0)->orderBy('updated_at','asc')->paginate(15);
        return view('manager.member.pending_regs')->with([
            'users' => $users,
        ]);
    }
