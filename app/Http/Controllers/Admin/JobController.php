...
class JobController extends Controller
{
    ...
    public function approve(Request $request){
        ...
        $message="<p>Dear {$emp->name},</p><p>Your project, {$job->title}, has been accepted by admin.</p>";
    ...
    public function delete(Request $request){
        ...
        $message="<p>Dear {$emp->name},</p><p>Your project, {$job->title}, has been rejected by admin.</p>";
        $data = array('sub'=>$sub,'message'=>$message);
        Mail::to($emp->email)->send(new GlobalMail($data));
