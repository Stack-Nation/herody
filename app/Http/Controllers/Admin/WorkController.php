...
class WorkController extends Controller
{
    public function pending(){
        ...
        return view('admin.work.pending')->with([
            'works' => $works
        ]);
    }
    ...
    public function all(){
        ...
        return view('admin.work.all')->with([
            'works' => $works
        ]);
    }
    ...
    public function approve(Request $request){
        ...
        $message="<p>Dear {$pending->employer->name},</p><p>Your work, {$pending->name}, has been accepted by admin.</p>";
    ...
    public function delete(Request $request){
        ...
        $message="<p>Dear {$job->employer->name},</p><p>Your work, {$job->name}, has been rejected by admin.</p>";
        $data = array('sub'=>$sub,'message'=>$message);
