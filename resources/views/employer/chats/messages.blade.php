	...
	<div class="container">
		...
		<div class="row">
            <div class="col-md-12">
                ...
                @else
                <form method="POST" action="{{route("employer.sendMessage")}}">
                    @csrf
                ...
                <div class="messages mt-4">
                    ...
                    @else
                        ...
                        @foreach($messages as $msg)
                            @if($msg->sender_id==Auth::guard("employer")->id() && $msg->sender_type==="Company")
                            <table class="table" style="@if($i%2!=0) background: #CCCECF; @endif overflow:auto;">
                                <tr>
                                    <td style="width:6%"><img src="{{asset('assets/employer/profile_images/'.\App\Employer::find(Auth::guard("employer")->id())->profile_photo)}}" class="border border-dark rounded-circle" height="60px" width="60px"></td>
                                    <td>{!!$msg->message!!}</td>
                                </tr>
                                <tr>
