...
@section('title', 'Admin | Custom Project Categories')
...
@section('body')
                    ...
                    <table class="table  table-striped table-bordered">
                        ...
                        @foreach($categories as $category)
                            <tr>
                                ...
                                <th scope="row">
                                    <form action="{{route('admin.custom-project.categories.delete')}}" method="post">
                                    @csrf
    ...
    <div class="modal fade" id="create" tabindex="-1" role="dialog" aria-labelledby="create">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{route('admin.custom-project.categories')}}" method="post">
                    @csrf
    ...
    {{--dropdown active--}}
    <script>
        $('#customProject li:nth-child(2)').addClass('active');
