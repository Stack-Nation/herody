		...
		<div class="row justify-content-center">
			<div class="col-12">
				<div class="section-title text-center mb-4 pb-2">
                    ...
                    <a href="{{route("user.support")}}" class="btn btn-info float-right">Initiate Support</a>
				</div>
			</div>
		</div>
		<div class="row">
                ...
                ?>
                    <li class="list-group-item">
                        ...
                        <span class="float-left">
                            ...
                            <a href="{{route("user.messages",[$type,$uid])}}" class="text-decoration-none text-truncate" style="color:black;display:block;height:100%;width:100%">
                                {!!$message->message!!}
                            </a>
                            </span>
                            <br/>
