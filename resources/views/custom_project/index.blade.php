	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-12">
                ...
                <form action="{{route("custom-project")}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row d-flex justify-content-center">
                        ...
                        <div class="col-md-10">
                            <div class="form-group">
                                <input type="text" class="form-control" name="startup" placeholder="Startup Name (optional)">
                            </div>
                        </div>
                        <div class="col-md-10">
                            <div class="form-group">
